...
using Net8CoreApiBoilerplate.DbContext.Entities;
using Net8CoreApiBoilerplate.DbContext.Entities.Identity;
using Net8CoreApiBoilerplate.DbContext.Interceptors;
using Net8CoreApiBoilerplate.Infrastructure.Settings;
using System.Diagnostics;

namespace Net8CoreApiBoilerplate.DbContext.Infrastructure
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.;Database=Net8CoreApiBoilerplate;Trusted_Connection=True;Encrypt=False;TrustServerCertificate=true;");
